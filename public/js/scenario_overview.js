...
// save data with bottom next role button
function save(id)
{
var id =$("#id").val();
...
var base_url = $('#base').val();
$.ajax({
url: base_url+"/Scenario/save_overview/"+id,
type:"POST",
data: $('#update_user').serialize(),
dataType: "JSON",
success: function(json){
...
// save overview data with save and exit button by Piyusha
   function exit(id)
{
var id =$("#id").val();
var base_url = $('#base').val();
...
// save overview data with sidebar injects by Piyusha
...
// save overview data with review button by Piyusha
function review(id){
var id =$("#id").val();
var base_url = $('#base').val();
$.ajax({
