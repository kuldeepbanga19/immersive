                  ...
                  <nav>
                     <ul class="ul">
                        <div class="nav-one">
                           ...
                           <div class="slide">
                              <input type="text" name="serach" style="padding: 0.3rem;" placeholder="What are you looking for?" class="common_select search">
...
<div class="footer-fixed">
   <div class="NavWrapperStyled-iws0ks-1 ktgAwU">
      ...
      <script type="text/javascript">
         ...
         $(".common_select").click(function(){
            ...
            $.ajax({
               ...
               async:false,
               dataType:"json",
               url:"<?=base_url()?>/Drill_player_setup/getfilterscenario",
               ...
               success:function(json){
                  if(json.success){
                     $(".filter_data3").html(json.filterddata);
                  }
               }
    ...
    function nextstep(sid){
      window.location.replace("<?=base_url();?>/Drill_player_setup/scenario_choose/"+sid);
      }
      </script>
