                  ...
                  <?php if($start_status == 0) { ?>
                          ...
                          <?php } 
                              ...
                              <?php foreach($assignusers_val as $asv){ ?>
                                 <?php if($asv['userid']==$usernameID && $asv['status']==0){?>

                                 <a href="<?= base_url('/Play_single_player/scenario_preview/'.$set_up_id)?>" data-toggle="tooltip" style="margin-right: 15px;">Play</i></a>

                                 <?php }

                               ?>
                                    <?php if($asv['userid']==$usernameID && $asv['status']==1){?>

                                    <a href="<?= base_url('/Play_single_player/result/'.$set_up_id)?>" data-toggle="tooltip">result</i></a>
      ...
      <div class="row">
         ...
         <div class="col-md-12">
            <div class="teacher-section d-flex justify-content-center mb-4">
             <div class="teacher nav nav-tabs me-4" id="myTab" role="tablist">


             <div class="teacher-img text-center nav-item d-flex" role="presentation">

                <?php foreach($roles as $rv){?>
                <div class="nav-link mb-2 customf-xnxj"id="home-tab<?=$rv['id']?>" data-bs-toggle="tab" data-bs-target="#home-pane<?=$rv['id']?>" type="button" role="tab" aria-controls="home-pane<?=$rv['id']?>" aria-selected="false">
                            <img src="<?=base_url();?>/images/Avatar+1.png" >
            ...
            <div class="roles-teacher">
               ...
               <?php if(isset($rolesinfo)){ 
                  foreach($roles as $rd){ ?>
                     ...
                     <div class="tab-pane fade " id="home-pane<?=$rd['id']?>" role="tabpanel" aria-labelledby="home-tab<?=$rd['id']?>" tabindex="0">
                        <h5><?=$rd["job_title"]?></h5>
      ...
      <div class="sc-jQbIHB gTZZqe">
         <table data-qaid="list-table" class="sc-fvhGYg iCcukv">
            ...
            <thead class="sc-GTWni cvdzQK" data-qaid="table-header">
               <tr>
                  <th class="sc-fbNXWD sc-gsxnyZ hNBkpm gULHZc" data-qaid="column-header-firstName" scope="col">Name <i class="fa fa-sort-asc"></i></th>
                  <th class="sc-fbNXWD sc-gsxnyZ hNBkpm gULHZc" data-qaid="column-header-state" scope="col">Status <i class="fa fa-sort-asc"></i></th>
                  ...
                  <th class="sc-fbNXWD sc-gsxnyZ hNBkpm gULHZc" data-qaid="column-header-lastActivityAt" scope="col">Last Activity <i class="fa fa-sort-asc"></i></th>
                  <th class="sc-fbNXWD sc-gsxnyZ hNBkpm gULHZc" data-qaid="column-header-results" scope="col">Results <i class="fa fa-sort-asc"></i></th>
               </tr>
            </thead>
            ...
            <?php foreach($assignusers_val as $asv){ ?>
               <tr class="sc-eGCarw jRBWWf">
                  ...
                  <td class="sc-fbNXWD sc-bXDlPE hNBkpm ffjFvC sc-fmlJLJ cPItqc" id="table-cell-BAh7CEkiCGdpZAY6BkVUSSJFZ2lkOi8vaW1tZXJzaXZlLWxhYnMtYXBpL0NyaXNpc1NpbTo6QXNzaWdubWVudC8xMzg5MDQ_ZXhwaXJlc19pbgY7AFRJIgxwdXJwb3NlBjsAVEkiDGRlZmF1bHQGOwBUSSIPZXhwaXJlc19hdAY7AFQw--9dddf7dc4d8c9492ecb2daa866709cafbc1324f7-1">
                     <div data-qaid="chip-Not Started" class="sc-lmoMRL fLWvJB ChipStyled-ggodje-1 gNpVcp"><span class="sc-eCssSg gAZCwn"> <?php if($asv['status']==0){
                           echo "Not Started";
...
function exercise_start_status(id,start_status){ 
   ...
   $(document).ready(function() {
      ...
      $('.customf-xnxj:first-child').addClass('active');
      $('.customf-xnxj:first-child').attr("aria-selected","true");
      $("img")
