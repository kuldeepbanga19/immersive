         ...
         <div class="row justify-content-center align-items-center">
			...
			<?= form_open('form1'); ?>
					...
					<div class="form-group mb-3">
					 ...
					 required pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,16}$" 
					 title="The Password must contain 8 to 16 characters with atleast 1 number,
					  1 uppercase character, 1 lowercase character, 1 special character" class="input-box" style="margin-top: 15px;"  value='<?= set_value('pass');?>'>
					...
					<div class="form-group mb-3">
					 ...
					 <input type="password" id="cpass" name="cpass" placeholder="Confirm New Password" required class="input-box" style="margin-top: 15px;"  value='<?= set_value('cpass');?>'>
					<?php if (isset($validation)){?>
                    <?php if ($validation->hasError('cpass')){?>
					...
					<div class="login-btn" style="margin-top: 35px;">
						<input type='submit'  name="validate_form" class="reset" value="RESET PASSWORD">
					</div>
