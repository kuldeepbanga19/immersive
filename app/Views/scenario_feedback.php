         ...
         <div class="row">
            ...
            <div class="col-md-6 second">
               ...
               <input type="hidden" name="id" id="id" value="<?php echo $user_obj1['id']; ?>">
                  ...
                  <!-- <form action="/action_page.php" class="p-4"> -->
                     ...
                     <p class="mb-0"><b>Provide Feedback</b> (Optional)</p>
                     <p class="mb-1">Do you want to provide feedback to the users?</p>
                     <input type="radio" name="feedback" class="me-2 yes" value=""<?php echo ($feedback1['feedback_type']!='')?'checked':''?>><b>Yes</b></input><br>
                     <input type="radio" name="feedback" class="me-2 no" value=""<?php echo ($feedback1['feedback_type']=='')?'checked':''?>><b>No</b></input>
                  </div>
                  <div class="internal-text mb-4 popup-second ">
                     <p class="mb-0"><b>Type</b></p>
                     <p class="mb-1">When do you want to provide this feedback?</p>
                     <input type="radio" name="feedback_type" class="me-2 feedback_type" value="1"<?php echo ($feedback1['feedback_type']=='1')?'checked':''?>><b>With each option</b></input><br>
                     <input type="radio" name="feedback_type" class="me-2 feedback_type" value="2"<?php echo ($feedback1['feedback_type']=='2')?'checked':''?>><b>With the result</b></input>
                  </div>
                    ...
                    <div class="footer">
                     <button type="button" aria-label="Back: Role" data-qaid="button-back" class="back-overview me-2" onclick="save_back()"><span>Back: Role</span></button>
                     <!-- <input type="submit" value="Next: Feedback" class="d-block ms-auto submit-btn"> -->
                     <button type="button" id="btnSave" onclick="save()" class="d-block ms-auto submit-btn">Ranking</button>
                     </div>
                  </form> 
               </div>
            </div>
            <div class="col-md-3 third">
               <div class="right-sidebar">
                  ...
                  <h6><b>Feedback</b></h6>
                     <p>If the goal of your scenario is to build awareness of a certain topic, it might be useful to offer feedback.</p>
                     <p>Feedback on the user’s responses can be presented throughout the scenario after each inject or with the results upon completion.</p></div>
               </div>
      ...
      <script type="text/javascript">
         $(document).ready(function(){
            ...
            $(".no").click(function(){
               ...
               $(".feedback_type").prop("checked", false);
...
function save(id)
    {
      ...
      // alert(id);
       ...
       // ajax adding data to database
          $.ajax({
            url : "<?=base_url();?>/Scenario_feedback/updateFeedback/" + id,
            type: "POST",
