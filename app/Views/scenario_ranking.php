         ...
         <div class="row">
            ...
            <div class="col-md-6 second">
               ...
               <input type="hidden" name="id" id="id" value="<?php echo $user_obj1['id']; ?>">
                  ...
                  <!-- <form action="/action_page.php" class="p-4"> -->
                     ...
                     <p class="mb-0"><b>Rank Options</b> (Optional)</p>
                     <p class="mb-1">Do you want to rank users' selected options?</p>
                     <input type="radio" name="ranking_type" class="me-2" value="1"<?php echo ($ranking1['rank_option']=='1')?'checked':''?>><b>Yes</b></input><br>
                     <input type="radio" name="ranking_type" class="me-2" value="2"<?php echo ($ranking1['rank_option']=='2')?'checked':''?>><b>No</b></input>
                  </div>
                    ...
                    <div class="footer">
                     <button type="button" aria-label="Back: Role" data-qaid="button-back" class="back-overview me-2" onclick="save_back()"><span>Back: Feedback</span></button>
                     <!-- <input type="submit" value="Next: Feedback" class="d-block ms-auto submit-btn"> -->
                     <button type="button" id="btnSave" onclick="save()" class="d-block ms-auto submit-btn">Analysis</button>
                     </div>
                  </form> 
               </div>
            </div>
            <div class="col-md-3 third">
               <div class="right-sidebar">
                  ...
                  <h6><b>Ranking</b></h6>
                     <p>You can rank each option according to how well it would fare in the real world. This can be presented to the user in a number of ways.</p></div>
               </div>
...
function save(id)
    {
      ...
      // alert(id);
       ...
       // ajax adding data to database
          $.ajax({
            url : "<?=base_url();?>/Scenario_ranking/updateRanking/" + id,
            type: "POST",
