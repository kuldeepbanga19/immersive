         ...
         <div class="row">
            ...
            <div class="col-md-9">
               ...
               <?php foreach($published_crisis as $published){?>
                  ...
                  <div class="col-md-3">
                  <a href="<?= base_url('/Single_player_setup/scenario_choose/'.$published['id'])?>" class="underline">
                     <div class="card">
...
<div class="footer-fixed">
   <div class="NavWrapperStyled-iws0ks-1 ktgAwU">
      ...
      <script type="text/javascript">
         ...
         $(".common_select").click(function(){
            ...
            $.ajax({
               ...
               async:false,
               dataType:"json",
               url:"<?=base_url()?>/Single_player_setup/getfilterscenario",
    ...
    function nextstep(sid){
      window.location.replace("<?=base_url();?>/Single_player_setup/scenario_choose/"+sid);
      }
