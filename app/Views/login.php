         ...
         <div class="row justify-content-center align-items-center">
            ...
            <div class="col-md-5 bg-white form-background">
               <div class="content">
                  ...
                  <?php endif;?>
                  <h3 style="color: red;"><?php $session = session(); echo $session->getFlashdata('login'); ?></h3>
                  ...
                  <div class="d-block text-end">
                     <button type="submit" class="btn btn-success sign-up">Signin</button>
                  </div>
                  <div class="ragister d-flex">
                      <p class="me-4"><a href="<?= base_url('/regis')?>">Register</a></p>
                      <p class="ms-4"><a href="<?= base_url('/forget_password')?>">Forgotten Password?</a></p>
                  </div>
                  </form>
               </div>
