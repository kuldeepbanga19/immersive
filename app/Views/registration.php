            ...
            <div class="col-md-5 bg-white form-background">
               ...
               <?= form_open('form'); ?>
                ...
                <div class="form-group mb-3">
                     ...
                     <i style="color:red; font-size:12px;"><?php if (isset($validation)){?>
                  ...
                  <div class="form-group mb-3">
                     ...
                     <input type="text" name="surname" value='<?= set_value('surname');?>'class="form-control">
                     <i style="color:red; font-size:12px;"><?php if (isset($validation)){?>
                    <?php if ($validation->hasError('surname')){?>
                ...
                <div class="form-group mb-3">
                  ...
                  <div class="form-group mb-3">
                     ...
                     <input type="password"  name="passcomf" value='<?= set_value('passcomf');?>'class="form-control">
                     <i style="color:red; font-size:12px;"><?php if (isset($validation)){?>
                    <?php if ($validation->hasError('passcomf')){?>
                        <?= $validation->getError('passcomf');?>
                        <?php } ?>   
                    <?php } ?></i>
                  </div>
                ...
                <button type="submit" value="Sign Up" class="btn btn-success sign-up next">Sign Up</button>
